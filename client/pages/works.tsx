    ...
    <Layout>
      ...
      <div className="headerBottom">
        <div className="container__inner">
          <h2 className="headerBottom__title" dangerouslySetInnerHTML={{ __html: page.title.rendered }}></h2>
          <h3 className="headerBottom__subtitle">{page.acf.subtitle}</h3>
        </div>
      </div>

      <div className={styles.worksWrapper}>
        <div className={styles.worksWrapper__body}>
          <h1 className={styles.worksWrapper__title}>{page.acf.portfolio_title}</h1>
